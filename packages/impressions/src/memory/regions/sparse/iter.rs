...
use super::{Entry, Segment, Sparse};

/// An iterator over the segments of a sparse region of memory.
#[derive(Clone, Debug)]
...
where
    T: Extent,
{
    /// Creates an iterator over the segments of a sparse region of memory.
    pub(super) fn new(segments: &'a Sparse<T>) -> Self {
        Self {
